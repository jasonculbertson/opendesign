...
description: 'Exercise for identifying immediate growth opportunities'
...
<Panel>
  <p class="text-[17px] leading-7 text-[#1a1f36]">
    This exercise helps identify immediate growth opportunities and create actionable plans for the next 3-6 months. It's designed to align individual growth with team and company goals.
  </p>
</Panel>
