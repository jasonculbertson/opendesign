...
<Panel>
  <p class="text-[17px] leading-7 text-[#1a1f36]">
    It's essential for every new team member to develop a 30/60/90 day plan, which they share with cross-functional peers and their manager for review and feedback. Below is an example plan:
  </p>
</Panel>
